    ...
    return(
        <div className="div_product">
            <div className="div_img_prod">
                <img className={'img_preview '+ imgClassName} src={imagePreview} alt='product' onLoad={controlPortraitsLoadingProcess} onClick={()=>{navigate(`/product/ID/${portraitID}`)}}></img>
                <div className="eyes_div" onClick={()=>{navigate(`/product/ID/${portraitID}`)}}>
